...
//         );
//         expect(CheckoutErrorMessage).to.equal(
//             'Данный способ оплаты недоступен'
//         );
//     });
...
//             '28Am5S'
//         );
//         await pageFactory.cart.type(
//             'nameField',
//             'Овсенкова Анастасия Николаевна '
//         );
...
//         );
//         expect(PaymentMethodFieldData).to.equal(
