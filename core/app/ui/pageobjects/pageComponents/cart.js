...
class Cart extends BaseElements {
    constructor() {
        ...
        this.deletionConfirmationButton =
            '.goods-table-popup__cell .remove-yes';
    ...
    async moveToFavorites() {
        try {
            ...
            await this.page
                .locator(this.confirmationMoveToFavoritesButton)
                .click();
                logger.info(`I move element to favorites`);
        } catch (error) {
